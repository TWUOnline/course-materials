...
-   **Demonstrate and discuss your work**, showcasing how you have engaged with course concepts.
...
By preparing thoughtfully and engaging in meaningful discussion, you will gain valuable insights into your learning progress and receive guidance to strengthen your knowledge and skills.

## Personal Learning Tracker

<a href="https://learn.twu.ca/mod/resource/view.php?id=1241198" class="btn btn-primary"><i class="bi bi-download fa fa-download"></i> &nbsp;&nbsp;Download Personal Learning Tracker</a>
...
1. **Download the Tracker**: [Click here to download the tracker.](https://learn.twu.ca/mod/resource/view.php?id=1241198){target="_blank"}
2. **Save & Rename**: Save the file to an easily accessible location on your computer (e.g., an LDRS 101 folder). Rename it using this format:
`LastName_FirstName_LDRS_101_Personal_Learning_Tracker`
...
<!-- 1.  **Update your tracker** as you complete each assignment, indicating your proficiency level and reflecting on your learning.

1.  **Use it as a guide** to prepare for your assessment conversation, highlighting key learning moments and areas where you seek feedback.

2.  **Engage in meaningful reflection**, considering how your skills are developing and how you can continue improving.

This tracker is not just a record of work—it’s a tool to help you take ownership of your learning, practice self-assessment, and develop proficiencies that extend beyond the course.-->
